 ...
 */
enum SFEVENT {SFEVENT_NULL, SFEVENT_QUIT, SFEVENT_UPDATE, SFEVENT_PLAYER_LEFT, SFEVENT_PLAYER_RIGHT, SFEVENT_PLAYER_NORTH,SFEVENT_BOSS, SFEVENT_GAMEOVER, SFEVENT_PLAYER_SOUTH, SFEVENT_FIRE, SFEVENT_COLLISION, SFEVENT_LAST};
